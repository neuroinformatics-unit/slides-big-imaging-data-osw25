...
:::: {.column}
::: {.column}
Even better idea: multiscale images [follow a standard.](https://ngff.openmicroscopy.org/0.4/index.html#image-layout).
:::
::: {.column}
...
::: aside
Versions roughly match the [HEFTIE textbook](https://heftie-textbook.readthedocs.io/en/latest/).
Find these slides at <https://neuroinformatics.dev/slides-big-imaging-data-osw25/>.
::: 
